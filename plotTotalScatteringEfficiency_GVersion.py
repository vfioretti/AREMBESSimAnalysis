"""
 plotTotalScatteringEfficiency_GVersion.py  -  description
 ---------------------------------------------------------------------------------
...
models = ['MultipleScattering', 'MultipleScattering_10.2']
models_title = ['Multiple Scattering 10.1', 'Multiple Scattering 10.2']
